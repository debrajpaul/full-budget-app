...
import { IS3Service } from '@common/abstractions';
import { S3, S3ClientConfig, GetObjectCommand, PutObjectCommand } from '@aws-sdk/client-s3';
...
export class S3Service implements IS3Service {
   ...
   */
  async putFile(bucket: string, key: string, body: Buffer | Uint8Array | string): Promise<void> {
