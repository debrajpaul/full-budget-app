...
const {
  ...
  DYNAMO_BUDGET_TABLE,
  DYNAMO_SAVINGS_GOAL_TABLE,
  DYNAMO_SINKING_FUND_TABLE,
  DYNAMO_REFRESH_TOKEN_TABLE,
  JWT_SECRET,
  AI_TAGGING_ENABLED,
...
export const config: IConfig = {
  ...
  dynamoSavingsGoalTable: DYNAMO_SAVINGS_GOAL_TABLE as string,
  dynamoSinkingFundTable: DYNAMO_SINKING_FUND_TABLE as string,
  dynamoRefreshTokenTable: DYNAMO_REFRESH_TOKEN_TABLE as string,
